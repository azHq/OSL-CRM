<div class="modal center fade" id="add_CRO" tabindex="-1" role="dialog" aria-modal="true" style="margin-top: 2em;">
	<div class="modal-dialog lkb-modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title text-center">Add Super Admin</h4>
				...
				<div class="row">
					<div class="col-md-12">
						<form action="{{ route('users.store') }}" method="POST">
							...
							<div class="row">
								<div class="col">
									<input hidden type="text" class="form-control" name="role" value="super-admin" required>
