								...
								<div class="col">
									<div class="form-group row">
										<div class="col-sm-12">
											...
											<select id="edit-student-status" class=" form-control form-select" name="status">
								...
								<div class="col">
									<div class="form-group row">
										<div class="col-sm-12">
											...
											<input id="edit-student-completion_date" type="date" class="form-control" name="completion_date" placeholder="{{date('Y-m-d')}}">
										</div>
									</div>
								</div>
								<div class="col">
