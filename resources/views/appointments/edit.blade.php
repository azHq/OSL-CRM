<div class="modal center fade" id="edit_user" tabindex="-1" role="dialog" aria-modal="true" style="margin-top: 2em;">
	<div class="modal-dialog lkb-modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title text-center">Edit Counsellor</h4>
